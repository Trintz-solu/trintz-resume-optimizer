...
# Imports after app (safe)
import models
import auth as auth_utils
from database import engine, get_db
from routers import auth_router, usage_router, billing_router, resume_router
...
async def optimize_resume_protected(
    ...
    if current_user.plan == models.PlanType.free and usage_count >= FREE_LIMIT:
        ...
        raise HTTPException(status_code=403, detail="Pro limit reached.")
